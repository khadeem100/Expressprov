...
class Dimensions {
  ...
  static const double paddingSizeTini = 3.0;
  ...
  static const double paddingThirty = 30.0;
  static const double paddingSizeExtraMoreLarge = 35.0;
  ...
  static const double signUpAppbarHeight = 90;
  static const double invoiceImageWidth = 6;
  static const double invoiceImageHeight = 2;
}